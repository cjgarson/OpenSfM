...
class Map {
 public:
  ...
  // ---- Aliases for aligned containers (note leading ::geometry) ----
  ...
  CameraView GetCameraView();  // defined in dataviews.cc
  ...
  ShotView GetShotView();  // defined in dataviews.cc
  ...
  PanoShotView GetPanoShotView();  // defined in dataviews.cc
  ...
  LandmarkView GetLandmarkView();  // defined in dataviews.cc
  ...
  // --- Bias ---
  BiasView GetBiasView();  // defined in dataviews.cc
