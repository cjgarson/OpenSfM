...
const std::unordered_map<LandmarkId, Landmark>& LandmarkView::GetLandmarks() const {
...
const std::unordered_map<CameraId, ::geometry::Camera>& CameraView::GetCameras() const {
...
const std::unordered_map<CameraId, ::geometry::Similarity>& BiasView::GetBiases() const {
...
const std::unordered_map<RigCameraId, RigCamera>& RigCameraView::GetRigCameras() const {
...
const std::unordered_map<RigInstanceId, RigInstance>& RigInstanceView::GetRigInstances() const {
