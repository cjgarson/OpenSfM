...
const std::unordered_map<ShotId, Shot>& ShotView::GetShots() const { return map_.GetShots(); }
...
const std::unordered_map<ShotId, Shot>& PanoShotView::GetShots() const { return map_.GetPanoShots(); }
...
const std::unordered_map<LandmarkId, Landmark>& LandmarkView::GetLandmarks() const { return map_.GetLandmarks(); }
...
const std::unordered_map<CameraId, ::geometry::Camera>& CameraView::GetCameras() const { return map_.GetCameras(); }
...
const std::unordered_map<CameraId, ::geometry::Similarity>& BiasView::GetBiases() const { return map_.GetBiases(); }
...
const std::unordered_map<RigCameraId, RigCamera>& RigCameraView::GetRigCameras() const { return map_.GetRigCameras(); }
...
const std::unordered_map<RigInstanceId, RigInstance>& RigInstanceView::GetRigInstances() const { return map_.GetRigInstances(); }
