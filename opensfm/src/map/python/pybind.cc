...
PYBIND11_MODULE(pymap, m) {
  ...
  // Declare ShotMeasurement types for Int, Double, etc.
  ...
  // Enum for error types (Pixel, Normalized, Angular)
  ...
  py::class_<sfmmap::Observation>(m, "Observation")
      ...
      .def("copy", [](const sfmmap::Observation &obs) {
           return sfmmap::Observation(obs);
       });

  // Landmark class binding
  ...
  // ShotMeasurements struct binding
  ...
  py::class_<sfmmap::RigInstance>(m, "RigInstance")
      ...
      .def_property("pose",
                    py::overload_cast<>(&sfmmap::RigInstance::GetPose, py::const_),
  ...
  shotCls
      ...
      .def_property("pose",
                    py::overload_cast<>(&sfmmap::Shot::GetPose, py::const_),
                    &sfmmap::Shot::SetPose,
                    py::return_value_policy::reference_internal)
      .def_property_readonly("camera", &sfmmap::Shot::GetCamera,
                             py::return_value_policy::reference_internal)
      .def("get_landmarks", &sfmmap::Shot::GetLandmarkObservations)
      .def("remove_landmark", &sfmmap::Shot::RemoveLandmarkObservation);

  // Map class binding
  mapCls
      .def(py::init<>())
      .def("get_shot", py::overload_cast<const sfmmap::ShotId&>(&sfmmap::Map::GetShot, py::const_),
           py::return_value_policy::reference_internal)
      .def("get_landmark", py::overload_cast<const sfmmap::LandmarkId&>(&sfmmap::Map::GetLandmark, py::const_),
           py::return_value_policy::reference_internal)
      .def("create_camera", &sfmmap::Map::CreateCamera)
      .def("create_shot", py::overload_cast<const sfmmap::ShotId&, const sfmmap::CameraId&,
      ...
      .def("remove_landmark", py::overload_cast<const sfmmap::LandmarkId&>(&sfmmap::Map::RemoveLandmark))
      .def("add_observation", py::overload_cast<sfmmap::Shot*, sfmmap::Landmark*, const sfmmap::Observation&>(&sfmmap::Map::AddObservation))
      .def("remove_observation", &sfmmap::Map::RemoveObservation)
      ...
      .def("get_topocentric_converter", &sfmmap::Map::GetTopocentricConverter,
           py::return_value_policy::reference_internal)
      .def("get_shots", &sfmmap::Map::GetShots,
           py::return_value_policy::reference_internal)
      .def("get_landmarks", &sfmmap::Map::GetLandmarks,
           py::return_value_policy::reference_internal);
}
